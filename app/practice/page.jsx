...
const Skills = () => {
  // Split skills into chunks for 2 rows layout
//   const chunkSize = Math.ceil(skills.length / 2);
//   const topRow = skills.slice(0, chunkSize);
//   const bottomRow = skills.slice(chunkSize);

  return (
    <section id="skills" className="py-16">
      <h1 className="p-6 text-3xl sm:text-4xl font-bold in-dark:text-white">
        Skills
      </h1>
      ...
      >
         ...
         {skills.map((skill) => (
            <SwiperSlide key={skill.id}>
              <div className="group flex flex-col items-center justify-center p-4 text-center cursor-pointer bg-white text-black border rounded-xl shadow hover:shadow-xl transition in-dark:bg-gray-300">
                <div className="text-4xl transition transform duration-300 group-hover:translate-y-2">
                  {skill.icons}
                </div>
